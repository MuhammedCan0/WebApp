...
public class SecurityUtils {
    ...
    private static final ThreadLocal<java.util.Set<com.university.tenant_service.common.Role>> currentRoles = new ThreadLocal<>();
    ...
    public static java.util.Set<com.university.tenant_service.common.Role> getCurrentRoles() {
    ...
    public static void setAuthentication(UUID userId,
                                         java.util.Set<com.university.tenant_service.common.Role> roles,
                                         String email,
